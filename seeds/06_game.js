  ...
  return knex('game').del()
    .then(function () {
      ...
      return knex('game').insert([
        ...
        {id: 3, black_player_id: 1, black_player_rank: 7, white_player_id: 16, white_player_rank: 10, game_result: 'Black', meeting_id: 4, board_num: 3},
        {id: 4, black_player_id: 9, black_player_rank: 14, white_player_id: 6, white_player_rank: 16, game_result: 'White', meeting_id: 4, board_num: 4},
        ...
        {id: 7, black_player_id: 2, black_player_rank: 5, white_player_id: 3, white_player_rank: 6, game_result: 'Draw', meeting_id: 5, board_num: 2},
        {id: 8, black_player_id: 1, black_player_rank: 7, white_player_id: 16, white_player_rank: 10, game_result: 'Black', meeting_id: 5, board_num: 3},
