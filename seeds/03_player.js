...
exports.seed = function(knex, Promise) {
  ...
  .then(function () {
    ...
    return knex('player').insert([
      ...
      {id: 20, first_name: 'Srikar', last_name: 'Kurakula',  birthday: new Date('2009-02-08 00:00:00 UTC')},
      ...
      {id: 56, first_name: 'Jerry', last_name: "Lou",  birthday: new Date('2008-06-06 00:00:00 UTC')},
